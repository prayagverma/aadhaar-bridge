...
public class AadhaarKycAsyncTask extends AsyncTask<String, Void, KycResponse> {
    ...
    protected static final String LOG_TAG = AadhaarKycAsyncTask.class.getSimpleName();
    protected ProgressDialog mDialog;
    protected Context ctx;
    protected ABSEvent event;

    KycCaptureData kycData;

    public AadhaarKycAsyncTask(Context ctx, ABSEvent event, KycCaptureData kycCaptureData) {
        this.kycData = kycCaptureData;
        this.ctx = ctx;
        this.event = event;
    }
    ...
    protected KycResponse doInBackground(String... params) {
        ...
        try {
            StringEntity entity = new StringEntity(GsonSerializerUtil.marshall(kycData));
            Log.d(LOG_TAG, "REQUEST : " + entity.toString());
